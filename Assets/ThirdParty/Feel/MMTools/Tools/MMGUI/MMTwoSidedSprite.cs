...
namespace MoreMountains.Tools
{
	...
	/// </summary>
	[ExecuteAlways]
	public class MMTwoSidedSprite : MonoBehaviour
	{
		...
		protected virtual void IfEditor()
		{
			...
			if (DebugMode)
			{
				...
				{
					case Axis.x:
						_transform.localScale = new Vector3(ScaleValue, _transform.localScale.y, _transform.localScale.z);
						break;
					case Axis.y:
						_transform.localScale = new Vector3(_transform.localScale.x, ScaleValue, _transform.localScale.z);
						break;
					case Axis.z:
						_transform.localScale = new Vector3(_transform.localScale.x, _transform.localScale.y, ScaleValue);
						break;
				}
			}
		}
